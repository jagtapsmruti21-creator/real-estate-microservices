import { Home, Building2, ClipboardList, CreditCard, FileText, Share2, MessageSquare, LogOut } from "lucide-react";
import { NavLink, Outlet, useNavigate } from "react-router-dom";
import { clearSession, getEmail } from "../lib/auth";

const nav = [
  { to: "/customer", label: "Home", icon: Home, end: true },
  { to: "/customer/projects", label: "Properties", icon: Building2 },
  ...
  { to: "/customer/referrals", label: "Referrals", icon: Share2 },
  { to: "/customer/feedbacks", label: "Feedbacks", icon: MessageSquare },
];
      ...
      <aside className="col-span-12 md:col-span-3 lg:col-span-2 bg-slate-100 border-r border-slate-200">
        <div className="p-4">
          <div className="rounded-2xl bg-white p-3 shadow-sm border border-slate-200">
            ...
            <div className="text-lg font-semibold">Customer Portal</div>
          </div>
      ...
      <main className="col-span-12 md:col-span-9 lg:col-span-10">
        <header className="sticky top-0 z-10 bg-slate-50/80 backdrop-blur border-b border-slate-200">
          <div className="px-6 py-4 flex items-center justify-between">
            ...
            <div className="text-xs text-slate-500">Your bookings & payments</div>
          </div>
        </header>
